  ...
  return (
    <div className='w-0 h-screen lg:hidden fixed overflow-hidden bg-yellow-400 z-50 flex flex-col justify-start items-center duration-300' id='hiddenNavbar'>
        ...
        <div className='flex flex-col space-y-12 items-center justify-center py-2'>
            ...
            <a href="#menu" className='text-2xl font-poppins text-black hover:bg-black hover:text-white duration-300 px-4 py-2'>Menu</a>
            <a href="#about" className='text-2xl font-poppins text-black hover:bg-black hover:text-white duration-300 px-4 py-2'>About</a>
            <a href="#testimontials" className='text-2xl font-poppins text-black hover:bg-black hover:text-white duration-300 px-4 py-2'>Testimontials</a>
