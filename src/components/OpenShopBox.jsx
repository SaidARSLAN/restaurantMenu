...
const OpenShopBox = () => {
  return (
    <div className='bg-yellow-400  h-0 overflow-auto flex absolute top-24 right-4 z-50 lg:right-36 lg:top-[100.3999px] lg:w-[300px] shadow-lg shadow-black duration-300' id='shopbox'>
